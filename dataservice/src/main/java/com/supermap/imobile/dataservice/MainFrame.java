...
public class MainFrame extends Activity implements OnClickListener{
    ...
    private boolean openDatasource(){
		...
		connectionInfo.setAlias("WorldMap");

		String s = connectionInfo.getAlias();
		Log.e("aaa", "getAlias : "+s);
    ...
    private boolean openMap(){  	
    	...
    	if(m_datasource != null){
			...
			int aaa = datasets.getCount();
			Log.e("aaa", "getCount : "+aaa);
    		m_mapControl.getMap().getLayers().add(datasets.get("Countries"), true);
    		m_mapControl.getMap().getLayers().add(datasets.get("Capitals"), true);
